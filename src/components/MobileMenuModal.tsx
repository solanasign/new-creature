                ...
                <div className="lg:col-span-2 space-y-12">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <Link
                        to="/sermons/in-him"
                        className="flex items-start space-x-4 hover:bg-gray-800 p-2 rounded-lg transition-colors"
                        onClick={onClose}
                      >
                        <div className="w-24 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center relative flex-shrink-0 overflow-hidden">
                          <img 
                            src={inHimm} 
                            alt="IN HIM Sermon" 
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-400 text-sm">Pastor David Ibukun · Dec 08, 2024</p>
                        </div>
                      </Link>
